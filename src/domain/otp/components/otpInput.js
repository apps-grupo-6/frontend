...
setTimeout(() => {
console.log("[OTP] Intentando abrir teclado automáticamente...");
if (inputRef.current) {
inputRef.current.focus();
console.log("[OTP] Focus aplicado automáticamente");
} else {
console.log("[OTP] inputRef.current es null");
}
}, 300);
});
...
const focusHidden = () => {
if (disabled) return;
console.log("[OTP] Abriendo teclado...");
inputRef.current?.focus();
};
